...
- **[Design the Application to display the news category wise]**
- **[Design and implement the functionality fetching News data from news API]**
- **[Desgin and implement the functionality of Displaying news headline in Cards]**
- **[Implement the infinite scroll bar functionality to keep fetching more news]**
- **[Implemented the functionality of react top loading bar]**
...
```sh
  cd my-folder
  git clone git@github.com:baqar-abbas/news-app-react.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
## 🙏 Acknowledgments <a name="acknowledgements"></a>
 ...
 I would like to thank ALL of them who support this idea about News App.
